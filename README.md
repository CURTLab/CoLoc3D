...
# Usage
The full user manual can be found [HERE](https://raw.githubusercontent.com/CURTLab/CoLoc3D/main/docs/CoLoc3D%20user%20manual.pdf) and examples are available in the attachment of the release.
